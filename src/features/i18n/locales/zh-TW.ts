...
export const zhTW = {
  ...
  settings: {
    ...
    display: { title: "顯示與互動", description: "獨立控制桌面、狀態列、列表和靈動島歌詞。", directControlHint: "解鎖後拖曳空白區域即可移動歌詞視窗。", manageShortcuts: "管理全域快速鍵",
      statusBar: { title: "狀態列歌詞", show: "顯示狀態列歌詞", showHint: "在 macOS 選單列顯示目前歌詞", width: "歌詞寬度", widthHint: "超出固定寬度的歌詞會自動捲動", textColor: "歌曲資訊顏色", textColorHint: "沒有可用歌詞時的歌曲名稱或預留文字使用", highlightColor: "已唱歌詞顏色", highlightColorHint: "已唱部分使用；沒有逐字時間軸時用於整句", inactiveColor: "未唱歌詞顏色", inactiveColorHint: "逐字歌詞尚未唱到的部分使用" },
      ...
      notch: { title: "靈動島歌詞", show: "顯示靈動島歌詞", showHint: "吸附螢幕頂部；懸停後展開快捷工具列", showTwoLines: "顯示下一句歌詞", translation: "顯示翻譯", romanization: "顯示音譯", fontSize: "字級", activeColor: "目前與已唱歌詞顏色", activeColorHint: "目前行及逐字歌詞已唱部分使用", inactiveColor: "未唱與下一句歌詞顏色", inactiveColorHint: "目前行未唱部分及開啟雙行時的下一句使用" } },
