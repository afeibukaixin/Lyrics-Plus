...
export const zhTW = {
  ...
  settings: {
    ...
    display: { title: "顯示與互動", description: "獨立控制桌面、選單列、歌詞視窗和靈動島。", directControlHint: "解鎖後拖曳空白區域即可移動歌詞視窗。", manageShortcuts: "管理全域快速鍵",
      ...
      listWindow: { title: "歌詞視窗", show: "顯示歌詞視窗", showHint: "顯示可捲動的完整歌詞視窗", lock: "鎖定歌詞視窗", lockHint: "鎖定後標頭和工具列會隱藏，滑鼠會穿透歌詞視窗。", translation: "顯示翻譯", romanization: "顯示音譯", activeColor: "目前行歌詞顏色", activeColorHint: "正在播放的歌詞行使用", inactiveColor: "其他行歌詞顏色", inactiveColorHint: "目前行以外的歌詞使用" },
