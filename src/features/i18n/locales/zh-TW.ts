...
export const zhTW = {
  ...
  settings: {
    ...
    player: { title: "播放器", description: "查看監聽狀態，並選擇播放來源、系統媒體篩選與播放器跟隨。", startup: "啟動與選單列", silentStartupHint: "啟動時不顯示設定視窗；桌面歌詞、播放器監聽與選單列仍會運作。", idleStatus: "等待播放", attentionStatus: "播放器需要處理", openAutomationSettings: "開啟自動化設定", allowSource: "加入允許清單", removeExcludedSource: "從排除清單移除", detectAgain: "重新偵測", useAuto: "切換為智慧選擇" },
    app: {
      ...
      themeLabel: "應用程式主題", themeHint: "影響設定、快速切換、日誌與設定檔編輯器，不改變桌面歌詞顏色。", fontScale: "設定介面字體大小", fontScaleHint: "調整設定、快速切換與進階工具的文字；視窗大小、控制項和桌面歌詞不受影響。",
