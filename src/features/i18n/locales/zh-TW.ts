...
export const zhTW = {
  ...
  settings: {
    shell: {
      navigation: "設定分類", closeToast: "關閉", advanced: "進階工具", resetTitle: "恢復分類預設設定",
      nav: {
    ...
    display: { title: "顯示與互動", description: "控制桌面歌詞的顯示、滑鼠穿透與位置。", directControlHint: "解鎖後拖曳空白區域即可移動歌詞視窗。", manageShortcuts: "管理全域快速鍵" },
    ...
    overlay: {
      ...
      presets: { violet: "紫羅蘭", ocean: "海洋藍", mint: "薄荷青", sunset: "夕陽橘", sakura: "櫻花粉", contrast: "黑白高對比", aurora: "極光青", indigo: "夜幕藍", coral: "珊瑚紅", lime: "萊姆綠", moonlight: "月光銀", neon: "霓虹紫" },
      ...
      secondarySize: "副歌詞字體大小", showTranslation: "顯示翻譯", translationSize: "翻譯字體大小", translationColor: "翻譯顏色", secondaryControlsHint: "在常用樣式中開啟翻譯或羅馬拼音後，可調整相應字體大小和顏色。",
