...
export const zhTW = {
  ...
  settings: {
    ...
    display: { title: "顯示與互動", description: "獨立控制桌面、狀態列、列表和靈動島歌詞。", directControlHint: "解鎖後拖曳空白區域即可移動歌詞視窗。", manageShortcuts: "管理全域快速鍵",
      ...
      notch: { title: "靈動島歌詞", show: "顯示靈動島歌詞", showHint: "吸附螢幕頂部；懸停後展開快捷工具列", display: "顯示器", primaryDisplay: "主要顯示器", displayFallback: "顯示器 {{index}}", autoHide: "未播放時自動隱藏", autoHideHint: "暫停、停止或播放器無法使用時隱藏；恢復播放後自動顯示（需啟用顯示靈動島歌詞）", showTwoLines: "顯示下一句歌詞", translation: "顯示翻譯", romanization: "顯示音譯", fontSize: "字級", activeColor: "目前與已唱歌詞顏色", activeColorHint: "目前行及逐字歌詞已唱部分使用", inactiveColor: "未唱與下一句歌詞顏色", inactiveColorHint: "目前行未唱部分及開啟雙行時的下一句使用" } },
