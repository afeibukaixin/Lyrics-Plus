...
export const enUS = {
  ...
  settings: {
    ...
    display: {
      ...
      notch: { title: "Dynamic Island Lyrics", show: "Show Dynamic Island lyrics", showHint: "Attach to the top of the display and reveal quick controls on hover", display: "Display", primaryDisplay: "Primary Display", displayFallback: "Display {{index}}", autoHide: "Hide when nothing is playing", autoHideHint: "Hide while paused, stopped, or unavailable, then show again when playback resumes (requires Dynamic Island lyrics to be enabled)", showTwoLines: "Show the next lyric line", translation: "Show translation", romanization: "Show romanization", fontSize: "Font size", activeColor: "Current and sung lyrics color", activeColorHint: "Used for the current line and sung portions of word-timed lyrics", inactiveColor: "Unsung and next-line lyrics color", inactiveColorHint: "Used for unsung portions of the current line and the next line in two-line mode" },
    },
    ...
    about: {
      ...
      updateCard: { downloading: "Downloading", installing: "Installing", ready: "Update ready", error: "Update failed", open: "Click to view" },
