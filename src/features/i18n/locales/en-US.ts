...
export const enUS = {
  ...
  legalNotice: {
    ...
    onlineDataBody: "When an online lyrics source is enabled, information used to match lyrics—such as track title, artist, album, and duration—is sent to the relevant third-party service.",
