...
export const enUS = {
  ...
  settings: {
    ...
    display: {
      ...
      statusBar: { title: "Menu Bar Lyrics", show: "Show menu bar lyrics", showHint: "Show the current lyric in the macOS menu bar", width: "Lyrics width", widthHint: "Lyrics that exceed this fixed width scroll automatically", textColor: "Track information color", textColorHint: "Used for the track title or placeholder when lyrics are unavailable", highlightColor: "Sung lyrics color", highlightColorHint: "Used for sung portions, or the whole line when word timing is unavailable", inactiveColor: "Unsung lyrics color", inactiveColorHint: "Used for portions of word-timed lyrics that have not been sung yet" },
