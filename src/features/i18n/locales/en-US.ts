...
export const enUS = {
  ...
  settings: {
    ...
    display: {
      title: "Display & Interaction", description: "Control visibility, click-through behavior, and position.",
    ...
    overlay: {
      ...
      secondarySize: "Secondary lyrics size", showTranslation: "Show translation", translationSize: "Translation size", translationColor: "Translation color", secondaryControlsHint: "Enable translation or romanization in Common Style to adjust its size and color.",
