...
export const enUS = {
  ...
  legalNotice: {
    ...
    onlineDataBody: "When online lyrics or network artwork fallback is enabled, matching information such as track title, artist, album, and duration is sent to the relevant third-party service.",
...
failed: "Lyrics directory scan failed",
  ...
  settings: {
    ...
    artwork: {
      ...
      networkFallback: "Network artwork fallback", networkFallbackHint: "Query third-party sources when player artwork is missing or its shortest side is below 256px.",
