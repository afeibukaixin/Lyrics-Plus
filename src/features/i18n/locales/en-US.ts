...
export const enUS = {
  ...
  settings: {
    ...
    player: { title: "Player", description: "Review listening status and choose the playback source, System Media filtering, and player following.", startup: "Startup & menu bar", silentStartupHint: "Do not show Settings at launch. Desktop lyrics, player monitoring, and the menu bar keep running.", idleStatus: "Waiting for playback", attentionStatus: "Player needs attention", openAutomationSettings: "Open Automation settings", allowSource: "Add to allowed apps", removeExcludedSource: "Remove from excluded apps", detectAgain: "Detect again", useAuto: "Switch to automatic" },
    app: {
