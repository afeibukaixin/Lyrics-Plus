...
failed: "Lyrics directory scan failed",
  ...
  settings: {
    ...
    app: {
      ...
      fontScale: "Settings text size", fontScaleHint: "Adjust text in Settings, Quick Switch, and advanced tools. Window sizes, controls, and desktop lyrics are unchanged.",
