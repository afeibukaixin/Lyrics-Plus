export const zhCN = {
  ...
  settings: {
    ...
    display: {
      ...
      listWindow: { title: "歌词窗口", show: "显示歌词窗口", showHint: "显示可滚动的完整歌词窗口", lock: "锁定歌词窗口", lockHint: "锁定后头部和工具栏隐藏，鼠标会穿透歌词窗口。", translation: "显示翻译", romanization: "显示音译", activeColor: "当前行歌词颜色", activeColorHint: "正在播放的歌词行使用", inactiveColor: "其他行歌词颜色", inactiveColorHint: "当前行以外的歌词使用" },
