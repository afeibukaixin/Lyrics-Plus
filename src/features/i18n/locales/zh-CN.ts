export const zhCN = {
  ...
  settings: {
    ...
    display: {
      ...
      notch: { title: "灵动岛歌词", show: "显示灵动岛歌词", showHint: "吸附屏幕顶部；悬停后展开快捷工具栏", showTwoLines: "显示下一句歌词", translation: "显示翻译", romanization: "显示音译", fontSize: "字号" },
    },
    ...
    overlay: {
      ...
      secondarySize: "副歌词字号", showTranslation: "显示翻译", translationSize: "翻译字号", translationColor: "翻译颜色", secondaryControlsHint: "在常用样式中开启翻译或音译后，可调整对应字号和颜色。",
