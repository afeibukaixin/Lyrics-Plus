export const zhCN = {
  ...
  settings: {
    ...
    lyrics: {
      ...
      autoMatch: "自动匹配", threshold: "自动匹配相似度", thresholdHint: "首条同步歌词达到此相似度时自动采用；低于阈值的结果仍可手动选择。", durationGuard: "检查歌词时间轴长度", durationGuardHint: "开启后，歌词末尾超过歌曲时长加下方容差时不会自动采用；手动选择不受影响。", durationTolerance: "歌词末尾容差", durationToleranceHint: "允许歌词时间轴比歌曲时长多出 0–60 秒；仅影响后台自动采用。关闭检查后仍会保留此数值。", autoSearchDebounce: "自动搜索防抖", autoSearchDebounceHint: "数值越低，自动歌词响应越快，但快速切歌会产生更多无效请求，并提高触发歌词源限流的风险；0 表示关闭。",
