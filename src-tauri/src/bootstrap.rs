...
pub fn run() {
    let app = ui_update::configure_protocol(configure_web_content_process_handler(tauri::Builder::default()))
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::clear_library_lyric_candidates,
            commands::preview_unbound_lyrics_cleanup,
            commands::cleanup_unbound_lyrics,
            commands::cleanup_selected_unbound_lyrics,
            ...
            commands::reset_provider_setting,
            commands::update_provider_policy,
            ...
            commands::import_local_lyrics,
            commands::select_lyrics_candidate,
            commands::clear_lyrics_binding,
            commands::set_lyrics_offset,
            commands::set_lyrics_offset_v2,
            commands::remove_lyrics_association,
            commands::get_song_association_candidates,
            commands::associate_song_candidate,
            commands::detach_platform_track,
            ...
            commands::set_library_root_enabled,
            commands::remove_library_root,
            commands::rescan_library_root,
            ...
            commands::open_font_panel,
            commands::get_font_available_weights,
            commands::close_font_panel,
            commands::set_theme,
            ...
            commands::reset_global_shortcut,
