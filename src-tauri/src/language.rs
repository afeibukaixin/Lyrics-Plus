...
impl UiLanguage {
    ...
    pub fn config_comment(self, comment: ConfigComment) -> &'static str {
        match (self, comment) {
            ...
            (Self::ZhCn, ConfigComment::SystemMediaApplications) => "自动模式允许的第三方系统播放应用；空数组表示全部允许。",
            ...
            (Self::EnUs, ConfigComment::SystemMediaApplications) => "Third-party system media apps allowed in auto mode; an empty list allows all.",
